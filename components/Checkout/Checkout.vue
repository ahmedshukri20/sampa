                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="billing-details">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12">
                                    <div class="form-group">
                                        <textarea name="notes" id="notes" v-model="personDetails.notes" cols="30" rows="4" placeholder="Order Notes" class="form-control"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-subtotal">
                                                <span class="subtotal-amount">
                                                    ${{parseFloat(cartTotal + 3).toFixed(2)}}
                                                </span>
                                            </td>
                                        </tr>
                                    </tbody>
