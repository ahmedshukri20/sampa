                    ...
                    <div class="blog-details-desc">
                        ...
                        <div class="article-content">
                            <div class="entry-meta">
                                <ul>
                                    <li><feather type="clock"></feather> <a href="#">September 31, 2022</a></li>
                                    <li><feather type="user"></feather> <a href="#">Steven Smith</a></li>
                                </ul>
                            </div>
                            ...
                            <ul class="features-list">
                                <li><feather type="check"></feather> Scientific Skills For getting a better result</li>
                                <li><feather type="check"></feather> Communication Skills to getting in touch</li>
                                <li><feather type="check"></feather> A Career Overview opportunity Available</li>
                                <li><feather type="check"></feather> A good Work Environment For work</li>
                            </ul>
